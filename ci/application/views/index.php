<?php
$titre = "Bienvenu sur Jarditou";
$description = "Passioné de jardinage, trouvez votre bonheur sur le site de E-commerce Jarditou";
?>
<?php include("cc/header.php");?>
        ...
        <div class="row mx-auto">
                ...
                <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 mb-2">
                    <div class="aside bg-secondary h-100 p-2 text-light">
